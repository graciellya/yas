...
export function Plasma({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: Event) => {
      ...
      mousePos.current.x = me.clientX - rect.left;
      mousePos.current.y = me.clientY - rect.top;
    ...
    if (mouseInteractive) {
      const target = trackWindow ? window : containerEl;
  ...
  }, [color, speed, direction, scale, opacity, mouseInteractive, trackWindow]);
